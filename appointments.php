...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-screen">
        ...
        <div class="appointment-card p-8">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
              ...
              <div>
              <label class="block text-sm font-medium text-gray-700 mb-3">Teacher (Optional)</label>
              <input 
    type="text" 
    name="teacher" 
  ...
  <p class="text-xs text-gray-500 mt-2 italic">
    Note: Leave this blank if your concern is not subject-related or if no specific teacher is required.
                    ...
                    <div id="otherReasonDiv" style="display:none;">
                      ...
                      <textarea name="other_reason" class="form-input w-full px-4 py-3 rounded-xl bg-white resize-none" placeholder="Please describe what you'd like to discuss or any specific concerns you have..." rows="4"></textarea>
                    </div>
                  </div>
                </div>
  ...
  <!-- Weekend Modal -->
<div id="weekendModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); justify-content:center; align-items:center;">
  <div style="background:white; padding:20px; border-radius:8px; max-width:300px; text-align:center;">
    <p>Appointments cannot be scheduled on Saturdays or Sundays.</p>
  ...
  if (main === "Personal") {
    ...
    // Hide subcategory dropdown for Others
    subDiv.style.display = "none";
    otherDiv.style.display = "block";
    return;
  }

  // Populate subcategory dropdown if options exist
