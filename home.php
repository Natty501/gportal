  ...
  <header class="bg-white/95 backdrop-blur-sm shadow-lg fixed top-0 left-0 w-full z-50">
    <div class="container mx-auto flex justify-between items-center py-4 px-6">
      ...
      <nav class="hidden md:flex space-x-8">
        <a href="javascript:void(0)" id="loginNavBtn" class="hover:text-purple-600 transition-colors font-medium">Login</a>
        <a href="home" class="hover:text-purple-600 transition-colors font-medium">Home</a>
    ...
    <div id="mobileMenu" class="mobile-menu fixed top-0 left-0 w-full h-full bg-white z-40 md:hidden">
      <div class="flex flex-col p-6 space-y-6 mt-16">
        <a href="login.php" class="text-xl font-medium hover:text-purple-600 transition-colors">Login</a>
...
<div id="videoModal" class="hidden fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      ...
      <div class="grid md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <div class="space-y-2">
            ...
            <a href="term_service.php" class="block hover:text-white transition-colors">Terms of Service</a>
  ...
  const loginNavMobileBtn = document.getElementById('loginNavMobileBtn');

  // Function to open modal with spinner
  function openLoginModal() {
    ...
    // After delay, hide spinner and show modal
    setTimeout(() => {
  ...
  // Attach modal open to Get Started buttons
  ...
  // Attach modal open to navbar login buttons
  if (loginNavBtn) loginNavBtn.addEventListener('click', openLoginModal);
  if (loginNavMobileBtn) loginNavMobileBtn.addEventListener('click', () => {
    openLoginModal();
  ...
  (function() {
    function c() {
      ...
      if (b) {
        ...
        d.innerHTML = "window.__CF$cv$params={r:'9858b71a50f50dcb',t:'MTc1ODk1MjE0MC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";
